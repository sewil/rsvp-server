...
namespace WvsBeta.Game.Packets
{
    public class MovePath
    {
        ...
        public static MovePath WarpPacket(MovableLife to)
        {
            var mp = new MovePath();
            mp.OriginalPosition = to.Position;

            mp.Elements = new MoveElement[]
            {
                new MoveElement
                {
                    Type = MovementType.Immediate,
                    X = mp.OriginalPosition.X,
                    Y = mp.OriginalPosition.Y,
                    Foothold = mp.NewFoothold,
                    Stance = mp.NewStance,
                    TimeElapsed = 0
                }
            };
