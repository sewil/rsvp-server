...
namespace WvsBeta.Game
{
    ...
    {
        public static bool ValidateMovePath(MovableLife life, MovePath path, long packetTime)
        {
            ...
            life.MoveAction = path.NewStance;
            life.LastMove = packetTime;
        ...
        public static void AddAvatar(Packet pPacket, Character pCharacter)
        {
            ...
            pPacket.WriteInt(pCharacter.Inventory.GetEquippedItemId(Constants.EquipSlots.Slots.Weapon, true));
        }
    }
}