...
namespace WvsBeta.Game
{
    ...
    public enum BuffValueTypes : ulong
    {
        ...
        Poison = 0x040000, // Mob Skill: Poison
        Seal = 0x080000, // Mob Skill: Seal
        ...
        // [Default unsupported] Byte 5
        Slow = 0x0100000000, // Mob Skill: Slow
    ...
    public class BuffDataProvider
    {
        public static readonly Dictionary<int, BuffValueTypes> SkillBuffValues = new Dictionary<int, BuffValueTypes>
        {
            ...
            {Constants.Swordman.Skills.IronBody, BuffValueTypes.WeaponDefense},
