...
namespace WvsBeta.Game
{
    ...
    public partial class ContinentMan
    {
        ...
        {
            if (fieldFrom == 0 || fieldTo == 0) return;
            if (!MapProvider.Maps.TryGetValue(fieldFrom, out var field)) return;

            field.ForEachCharacters(character =>
            {
                // Little hack
