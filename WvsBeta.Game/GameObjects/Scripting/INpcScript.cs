...
namespace WvsBeta.Game
{
    ...
    public interface IHost
    {
        ...
        void SendErrorMessage(int npcId, int state);

        void GetQuestIsAvailableFormat(string title, string questName, int idx);
        void GetQuestIsCompletedFormat(string title, string questName, int idx);
        void GetQuestIsInProgressFormat(string title, string questName, int idx);
    }
}