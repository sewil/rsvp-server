...
public class ItemData
{
    ...
    public bool PickupBlocked { get; set; }
    ...
    public short Seal { get; set; }
    public short Darkness { get; set; }
    public short Weakness { get; set; }
    public short Curse { get; set; }
    ...
    public byte IncCraft { get; set; }
    public byte IncHands => IncCraft;
    ...
    public int PetFullness { get; set; }
    public int PetLife { get; set; }
