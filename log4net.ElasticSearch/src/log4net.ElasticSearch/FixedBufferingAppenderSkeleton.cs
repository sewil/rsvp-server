...
namespace log4net.Appender
{
	...
	public abstract class FixedBufferingAppenderSkeleton : AppenderSkeleton
	{
		...
		/// </para>
		/// </remarks>
		protected FixedBufferingAppenderSkeleton() : this(true)
		{
		}
		...
		/// </para>
		/// </remarks>
		protected FixedBufferingAppenderSkeleton(bool eventMustBeFixed) : base()
		{
