    ...
    public partial class DataBasePatcher
    {
        class PatchFile
        {
            ...
            private void CalculateFileHash()
            {
                ...
                var hash = SHhash.ComputeHash(Encoding.ASCII.GetBytes("" + ScriptUp + ScriptDown));
            ...
            public static PatchFile TryParsePatchFile(string filename)
            {
                ...
                if (currentState == ParsingState.JustStarted)
                    throw new Exception("Did not find separators. Script: " + filename);
            ...
            public static PatchFile TryParseRow(MySqlDataReader dataReader)
            {
                ...
                return new PatchFile
                {
                    ...
                    ScriptDown = dataReader.IsDBNull(dataReader.GetOrdinal("script_down")) ? null : dataReader.GetString("script_down"),
