...
namespace WvsBeta.Center
{
    public class WorldServer
    {
        ...
        {
            pw.WriteByte(GetLoadState());
        }

        public WorldLoadState GetLoadState()
        {
            var load = CalculateWorldLoad();
            if (load > UserLimit) return WorldLoadState.Full;
            if (load > UserWarning) return WorldLoadState.Warning;
            return WorldLoadState.OK;
        }
